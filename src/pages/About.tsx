            ...
            <Card className="max-w-md overflow-hidden shadow-lg">
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="flex justify-center mt-6 space-x-4">
                  <a href="https://www.linkedin.com/in/muhammedadnanvv/?locale=en_US" className="text-retail-600 hover:text-retail-800 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
                  </a>
                  <a href="https://x.com/MuhammadAd93421" className="text-retail-600 hover:text-retail-800 transition-colors">
